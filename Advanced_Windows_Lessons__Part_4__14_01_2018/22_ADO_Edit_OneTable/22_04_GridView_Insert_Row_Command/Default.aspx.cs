...
public partial class _Default : System.Web.UI.Page 
{
    ...
    {
        myDataTable.Rows[e.RowIndex]["Family"] = ((TextBox)(GridView1.Rows[e.RowIndex].Cells[4].Controls[0])).Text;
        myDataTable.Rows[e.RowIndex]["Name"] = ((TextBox)(GridView1.Rows[e.RowIndex].Cells[5].Controls[0])).Text;
    ...
    {
        string strSQL = "INSERT INTO Table_Address_Tel(Family,Name) VALUES(null, null)";
        SqlCommand myCommand = new SqlCommand(strSQL, myConnect);
        myConnect.Open();
        myCommand.ExecuteNonQuery();
        myConnect.Close();
