...
<body>
    ...
    <div>
        <asp:TextBox ID="TextBox1" runat="server" Height="41px" Style="z-index: 100; left: 23px;
            position: absolute; top: 31px" Width="249px"></asp:TextBox>
        <asp:TextBox ID="TextBox2" runat="server" EnableTheming= "false" Height="39px" Style="z-index: 100; left: 329px;
        ...
        <asp:Button ID="Button1" runat="server" Height="56px" OnClick="Button1_Click" Style="z-index: 101;
            left: 74px; position: absolute; top: 87px" Text="Button" Width="116px" />
        ...
        <asp:Label ID="Label1" runat="server" Height="42px" Style="z-index: 103; left: 25px;
            position: absolute; top: 152px" Width="256px" ></asp:Label>
