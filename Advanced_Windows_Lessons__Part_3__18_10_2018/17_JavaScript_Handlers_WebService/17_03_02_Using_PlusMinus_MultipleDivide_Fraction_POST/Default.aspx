...
///		        myJSON_Object[0] = { 'num': parseInt(document.getElementById('TextBox1').value), 'denom': parseInt(document.getElementById('TextBox2').value) };
		        ...
		        var url = "http://localhost:50892/PlusMinus_MultipleDivide_Fraction_HttpTaskAsyncHandler_POST/Handler.ashx";
		        xmlHttp.open("POST", url, true);
		        xmlHttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
		        xmlHttp.onreadystatechange = onRequest;
		        xmlHttp.send("cmd=" + PlusMinusMultipleDivide.toString() + "&JsonString_0=" + myJsonString_0 + "&JsonString_1=" + myJsonString_1);
		    }
