...
//				document.getElementById('<%= Label1.ID %>').innerText = document.getElementById('<%= TextBox1.ID %>').value;
			    document.getElementById('Label1').innerText = document.form1.TextBox1.value;
///				document.getElementById('Label1').innerText = document.forms[0].TextBox1.value;
			}
		</script>
